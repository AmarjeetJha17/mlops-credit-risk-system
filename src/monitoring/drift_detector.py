...
CURRENT_DATA_PATH = "data/processed/production_logs.csv" # In reality, fetched from your DB
...
def check_thresholds_and_alert():
    ...
    logging.info(f"Drift Detected: {dataset_drift}. Drifted Columns: {drifted_columns}/{total_columns}")
