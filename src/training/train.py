...
from sklearn.metrics import (roc_auc_score, f1_score, precision_score, 
                             recall_score, log_loss, confusion_matrix, ConfusionMatrixDisplay)
...
def main():
    ...
    models = {
        ...
        "RandomForest": RandomForestClassifier(class_weight='balanced', n_estimators=100, max_depth=10, random_state=42, n_jobs=-1),
        "LightGBM": lgb.LGBMClassifier(scale_pos_weight=imbalance_ratio, n_estimators=100, random_state=42, n_jobs=-1),
        "XGBoost": xgb.XGBClassifier(scale_pos_weight=imbalance_ratio, n_estimators=100, random_state=42, n_jobs=-1, eval_metric='logloss')
    }
